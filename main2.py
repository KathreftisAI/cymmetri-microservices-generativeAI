...
if response.status_code == 200:
    ...
    if isinstance(json_data, list) and len(json_data) > 0:
        # Send each record to OpenAI for schema extraction
        ...
        for record in json_data:
            openai_payload = {
                "prompt": f"Give me list of fields as jsonPath and labels and datatype and value in this json sample {record}",
                "max_tokens": 800,
                "temperature": 0.2,
                "frequency_penalty": 0,
                "presence_penalty": 0,
